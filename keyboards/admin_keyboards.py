...
class AdminKeyboards:
    ...
    def menu() -> InlineKeyboardMarkup:
        ...
        kb.row(
            InlineKeyboardButton(
                text=buttons["admin_mailing"],
                callback_data=callbacks[buttons["admin_mailing"]],
            ),
            InlineKeyboardButton(
                text=buttons["admin_events"],
                callback_data=callbacks[buttons["admin_events"]],
            ),
        )
        kb.adjust(1, 1)
    ...
    def back_to_menu() -> InlineKeyboardMarkup:
        ...
        kb.row(
            InlineKeyboardButton(
                text=buttons["admin_back_to_menu"],
    ...
    def upcoming_events(events: List[dict]) -> InlineKeyboardMarkup:
        ...
        for (
            ...
            kb.add(
                InlineKeyboardButton(
                    text=event["name"], callback_data=f"admin_event_{event['id']}"
                )
            )

        kb.row(
            InlineKeyboardButton(
                text=buttons["admin_create_event"],
    ...
    def confirm_creation_of_event():
        ...
        kb.row(
            InlineKeyboardButton(
                text=buttons["admin_creation_of_event_confirm"],
                callback_data=callbacks[buttons["admin_creation_of_event_confirm"]],
            ),
            InlineKeyboardButton(
                text=buttons["admin_creation_of_event_cancel"],
    ...
    def mailing_options() -> InlineKeyboardMarkup:
        ...
        kb.add(
            InlineKeyboardButton(
                text=buttons["admin_mailing_options_all"],
                callback_data=callbacks[buttons["admin_mailing_options_all"]],
            ),
            InlineKeyboardButton(
                text=buttons["admin_mailing_options_event-participants"],
                callback_data=callbacks[
                    buttons["admin_mailing_options_event-participants"]
                ],
            ),
            InlineKeyboardButton(
    ...
    def confirm_mailing() -> InlineKeyboardMarkup:
        ...
        kb.add(
            InlineKeyboardButton(
                text=buttons["initiate_mailing"],
                callback_data=callbacks[buttons["initiate_mailing"]],
            ),
            InlineKeyboardButton(
                text="❌ Отмена", callback_data=callbacks[buttons["admin_back_to_menu"]]
            ),
        ).adjust(1)
